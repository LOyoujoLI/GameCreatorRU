...
| ---  |
| **[addEventListener](#addEventListener)**(obj : any,  type : string,  callBack : [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback),  isOnce? : boolean): void<br>[Static] Registration Event
...
| **[removeEventListener](#removeEventListener)**(obj : any,  type : string,  callBack : [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback)): void<br>[Static] Remove event
...
## addEventListener
###### **[addEventListener](#addEventListener)**(obj : any,  type : string,  callBack : [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback),  isOnce? : boolean): void :
...
## removeEventListener
###### **[removeEventListener](#removeEventListener)**(obj : any,  type : string,  callBack : [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback)): void :
[Static] Remove event
##### Parameters
	obj Event Object
	type Type
