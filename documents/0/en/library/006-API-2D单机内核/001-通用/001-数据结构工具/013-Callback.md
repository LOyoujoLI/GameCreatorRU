...
| **[delayRun](#delayRun)**(delay : number,  delayFunc? : Function,  args? : any[]): [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback)<br>Delayed execution
| **[delayRunConver](#delayRunConver)**(delay : number,  delayFunc? : Function,  clearDelayFunc? : Function,  args? : any[]): [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback)<br>Delays execution, but overwrites previous delays
| **[stopDelay](#stopDelay)**(clearDelayFunc? : Function): void<br>Stop extension
| **[New](#New)**(callbackFunc : Function,  caller : any,  args? : any[]): [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback)<br>[Static] New callback object, same as new CallBack
...
## delayRun
###### **[delayRun](#delayRun)**(delay : number,  delayFunc? : Function,  args? : any[]): [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback) :
Delayed execution
##### Parameters
...
## delayRunConver
###### **[delayRunConver](#delayRunConver)**(delay : number,  delayFunc? : Function,  clearDelayFunc? : Function,  args? : any[]): [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback) :
...
## New
###### **[New](#New)**(callbackFunc : Function,  caller : any,  args? : any[]): [Callback](?file=006-API-2D单机内核/001-通用/001-数据结构工具/013-Callback) :
