...
| **[matchAttributesD2](#matchAttributesD2)**(arr : any,  attribute : string,  matchData : any,  onlyOne : boolean,  symbol? : string: any[]<br>【Static] Matching data Depth 2, used to match whether the object in the object contains the property
| **[matchAttributesD3](#matchAttributesD3)**(arr : any,  attribute : string,  attribute2 : string,  matchData : any,  onlyOne : boolean,  symbol? : string): any[]<br>[Static] Matching Data Depth 3
