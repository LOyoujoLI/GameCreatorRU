...
| **[getBezierPoint2](#getBezierPoint2)**(startX : number,  startY : number,  CtrlX : number,  CtrlY : number,  endX : number,  endY : number,  t : number,  resultPoint? : [Point](?file=006-API-2D单机内核/001-通用/019-Point)): [Point](?file=006-API-2D单机内核/001-通用/019-Point)<br>[Static] Calculate the specific position of a point on a quadratic Bessel curve
...
## getBezierPoint2
###### **[getBezierPoint2](#getBezierPoint2)**(startX : number,  startY : number,  CtrlX : number,  CtrlY : number,  endX : number,  endY : number,  t : number,  resultPoint? : [Point](?file=006-API-2D单机内核/001-通用/019-Point)): [Point](?file=006-API-2D单机内核/001-通用/019-Point) :
