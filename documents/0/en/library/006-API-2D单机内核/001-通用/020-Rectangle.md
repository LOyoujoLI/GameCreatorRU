...
| **[setTo](#setTo)**(x : number,  y : number,  width : number,  height : number): [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)<br>Set the specified values one at a time
| **[contains](#contains)**(x : number,  y : number): boolean<br>Whether to include the specified points
| **[intersects](#intersects)**(rect : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): boolean<br>Intersects or not intersects another specified rectangle
| **[intersection](#intersection)**(rect : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle),  out? : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)<br>Get the area that intersects the specified rectangle
| **[union](#union)**(source : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle),  out? : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)<br>Combine the two rectangles by filling the horizontal and vertical space between them to create a new Rectangle object
| **[clone](#clone)**(out? : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)<br>Returns a clone of this object
| **[toString](#toString)**(): string<br>Returns the value in string form: x,y,width,height
| **[equals](#equals)**(rect : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): boolean<br>Is equal to the specified rectangle
...
## setTo
###### **[setTo](#setTo)**(x : number,  y : number,  width : number,  height : number): [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle) :
...
## intersects
###### **[intersects](#intersects)**(rect : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): boolean :
...
## intersection
###### **[intersection](#intersection)**(rect : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle),  out? : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle) :
...
## union
###### **[union](#union)**(source : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle),  out? : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle) :
...
## clone
###### **[clone](#clone)**(out? : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle) :
...
## equals
###### **[equals](#equals)**(rect : [Rectangle](?file=006-API-2D单机内核/001-通用/020-Rectangle)): boolean :
