...
| **[setTo](#setTo)**(x : number,  y : number): [Point](?file=006-API-2D单机内核/001-通用/019-Point)<br>Set horizontal and vertical coordinates at once
...
| **[interpolate](#interpolate)**(to : [Point](?file=006-API-2D单机内核/001-通用/019-Point),  from : [Point](?file=006-API-2D单机内核/001-通用/019-Point),  per : number): [Point](?file=006-API-2D单机内核/001-通用/019-Point)<br>[Static] Return the point in the middle of from-to two points
...
| **[distance](#distance)**(from : [Point](?file=006-API-2D单机内核/001-通用/019-Point),  to : [Point](?file=006-API-2D单机内核/001-通用/019-Point)): number<br>[Static] Return the distance between two points of from-to
...
| **[distanceSquare](#distanceSquare)**(p1 : [Point](?file=006-API-2D单机内核/001-通用/019-Point),  p2 : [Point](?file=006-API-2D单机内核/001-通用/019-Point)): number<br>[Static] Square of distance
...
## setTo
###### **[setTo](#setTo)**(x : number,  y : number): [Point](?file=006-API-2D单机内核/001-通用/019-Point) :
...
## interpolate
###### **[interpolate](#interpolate)**(to : [Point](?file=006-API-2D单机内核/001-通用/019-Point),  from : [Point](?file=006-API-2D单机内核/001-通用/019-Point),  per : number): [Point](?file=006-API-2D单机内核/001-通用/019-Point) :
...
## distance
###### **[distance](#distance)**(from : [Point](?file=006-API-2D单机内核/001-通用/019-Point),  to : [Point](?file=006-API-2D单机内核/001-通用/019-Point)): number :
...
## distanceSquare
###### **[distanceSquare](#distanceSquare)**(p1 : [Point](?file=006-API-2D单机内核/001-通用/019-Point),  p2 : [Point](?file=006-API-2D单机内核/001-通用/019-Point)): number :
