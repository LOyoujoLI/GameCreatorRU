...
**Subcategories**  [GCAnimation](?file=006-API-2D单机内核/002-客户端/011-GCAnimation)、[Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar)、[ClientSceneLayer](?file=006-API-2D单机内核/002-客户端/017-ClientSceneLayer)、[GameImageLayer](?file=006-API-2D单机内核/002-客户端/025-GameImageLayer)、[GameLayer](?file=006-API-2D单机内核/002-客户端/026-GameLayer)<br>
## **Public Properties**
...
| **[setMaterialsByGameSprite](#setMaterialsByGameSprite)**(gameSprite : [GameSprite](?file=006-API-2D单机内核/002-客户端/027-GameSprite),  cloneMode : boolean):void<br>Set to the same material as the specified GameSprite
...
###### **[setMaterialsByGameSprite](#setMaterialsByGameSprite)**(gameSprite : [GameSprite](?file=006-API-2D单机内核/002-客户端/027-GameSprite),  cloneMode : boolean): void :
