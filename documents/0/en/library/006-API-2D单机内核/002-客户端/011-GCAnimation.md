...
| **preAnimationLowLayers** : GameSprite[];<br>Predetermined layer: a lower level than the target layer  |
| **preAnimationHighLayers** : GameSprite[];<br>Predetermined layer: a higher level than the target layer  |
