...
| ---  |
| **selected** : boolean;<br>Change selected state |
...
| **[onChangeFragEvent](#onChangeFragEvent)** : string;<br>Fragment event content: triggered when selected changes  |
...
Fragment event content: triggered when selected changes<br>
