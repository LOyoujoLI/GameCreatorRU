...
| **[onChangeFragEvent](#onChangeFragEvent)** : string;<br>Fragment event content: triggered when the selected item is changed  |
...
Fragment event content: triggered when the selected item is changed<br>
