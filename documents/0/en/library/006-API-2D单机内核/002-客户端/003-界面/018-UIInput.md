...
| **maxChars** : number;<br>Maximum number of characters that can be entered Default Value=99999  |
| **[onInputFragEvent](#onInputFragEvent)** : string;<br>Fragment event content: triggered when text is entered  |
| **[onEnterFragEvent](#onEnterFragEvent)** : string;<br>Fragment event content: triggered when OK is pressed on Enter  |
...
Fragment event content: triggered when text is entered<br>
Active call method: CommandPage.startTriggerFragmentEvent
### onEnterFragEvent
###### onEnterFragEvent : string;
Fragment event content: triggered when OK is pressed on Enter<br>
Active call method: CommandPage.startTriggerFragmentEvent
