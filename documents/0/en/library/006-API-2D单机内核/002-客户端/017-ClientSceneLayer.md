...
| ---  |
| **[constructor](#constructor)**(scene : [ClientScene](?file=006-API-2D单机内核/002-客户端/016-ClientScene))<br>Constructors
...
## constructor
###### **[constructor](#constructor)**(scene : [ClientScene](?file=006-API-2D单机内核/002-客户端/016-ClientScene)) :
Constructors
##### Parameters
