...
>Main functions:<br>-- Used to work with custom commands<br>-- Trigger events: scene events, scene object events, interface events, event library events (and fragment events trigger reference)[CommandPage](?file=006-API-2D单机内核/001-通用/013-CommandPage)）<br>-- Submit player input information<br><br>
...
| **[startSceneObjectCommand](#startSceneObjectCommand)**(sceneObjectIndex : number,  indexType : number,  inputMessage? : any[],  onCommandExecuteOver? : Callback,  triggerSceneObject? : [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject)): boolean<br>[Static] [Scene Object-Event] Active start new trigger of this event
...
| **[startCommonCommand](#startCommonCommand)**(id : number,  inputMessage? : any[],  onCommandExecuteOver? : Callback,  triggerSceneObject? : [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject),  executorSceneObject? : [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject)): void<br>[Static] [Independent Event - Event Library Event] Active start execution
...
###### **[startSceneObjectCommand](#startSceneObjectCommand)**(sceneObjectIndex : number,  indexType : number,  inputMessage? : any[],  onCommandExecuteOver? : Callback,  triggerSceneObject? : [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject)): boolean :
...
## startCommonCommand
###### **[startCommonCommand](#startCommonCommand)**(id : number,  inputMessage? : any[],  onCommandExecuteOver? : Callback,  triggerSceneObject? : [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject),  executorSceneObject? : [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject)): void :
