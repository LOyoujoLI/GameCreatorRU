...
| **[EVENT_BEFORE_RECOVERY_DIALOG](#EVENT_BEFORE_RECOVERY_DIALOG)** : string;<br>[Static] Event: Called before the conversation when restoring the archive  |
...
>// success = Is the playback successful<br>
>// audioURL = Voice string (if any) Format: Audio address,Volume 0-1,Tone 0-2<br>
...
[Static] Event: Called before the conversation when restoring the archive<br>
