...
| **[addPartByAvatar](#addPartByAvatar)**(partID : number,  part : [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar),  partIndex? : number): boolean<br>Adds a part, depending on the part object, or ignores it if it already exists
...
| **[removePartByPartID](#removePartByPartID)**(partID : number,  disposeOldPart? : boolean): [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar)<br>Remove part: according to the specified part ID
| **[removePartByAvatar](#removePartByAvatar)**(part : [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar),  disposeOldPart? : boolean): boolean<br>Removal part: According to the part object
| **[changePartByAvatar](#changePartByAvatar)**(newPart : [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar),  partID : number): boolean<br>Replacement part: according to the new part and part ID
...
| **[getPartByPartID](#getPartByPartID)**(partID : number): [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar)<br>Get the part: according to the part ID
| **[getPartAt](#getPartAt)**(partIndex : number): [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar)<br>Get the part according to the index of the location where the part is located
| **[getPartByID](#getPartByID)**(avatarID : number): [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar)<br>Get the part according to the database ID corresponding to the part
| **[getPartIndex](#getPartIndex)**(avatar : [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar)): number<br>Get the index of a part by its location
...
## addPartByAvatar
###### **[addPartByAvatar](#addPartByAvatar)**(partID : number,  part : [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar),  partIndex? : number): boolean :
...
## removePartByPartID
###### **[removePartByPartID](#removePartByPartID)**(partID : number,  disposeOldPart? : boolean): [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar) :
...
## removePartByAvatar
###### **[removePartByAvatar](#removePartByAvatar)**(part : [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar),  disposeOldPart? : boolean): boolean :
...
## changePartByAvatar
###### **[changePartByAvatar](#changePartByAvatar)**(newPart : [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar),  partID : number): boolean :
...
## getPartByPartID
###### **[getPartByPartID](#getPartByPartID)**(partID : number): [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar) :
...
## getPartAt
###### **[getPartAt](#getPartAt)**(partIndex : number): [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar) :
...
## getPartByID
###### **[getPartByID](#getPartByID)**(avatarID : number): [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar) :
...
## getPartIndex
###### **[getPartIndex](#getPartIndex)**(avatar : [Avatar](?file=006-API-2D单机内核/002-客户端/013-Avatar)): number :
...
@frame [optional] the number of frames to jump, default frame=1, 1 means the first frame
