...
| ---  |
| **[isHitGraphic](#isHitGraphic)**(x : number,  y : number,  graphic : [Graphics](?file=006-API-2D单机内核/002-客户端/001-渲染引擎/012-Graphics)): boolean<br>[Static] Whether to hit Graphic
...
## isHitGraphic
###### **[isHitGraphic](#isHitGraphic)**(x : number,  y : number,  graphic : [Graphics](?file=006-API-2D单机内核/002-客户端/001-渲染引擎/012-Graphics)): boolean :
