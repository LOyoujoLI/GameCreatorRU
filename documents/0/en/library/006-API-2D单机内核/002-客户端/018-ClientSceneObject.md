...
**Inheritance**  →[SceneObjectEntity](?file=006-API-2D单机内核/001-通用/026-SceneObjectEntity)→[SceneObject](?file=006-API-2D单机内核/001-通用/024-SceneObject)<br>
...
| ---  |
| **[constructor](#constructor)**(soData? : [SceneObject](?file=006-API-2D单机内核/001-通用/024-SceneObject),  scene? : [ClientScene](?file=006-API-2D单机内核/002-客户端/016-ClientScene))<br>Constructors
...
| **[playAnimation](#playAnimation)**(aniID : number,  loop : boolean,  isHit : boolean,  fps? : number,  superposition? : boolean): [GCAnimation](?file=006-API-2D单机内核/002-客户端/011-GCAnimation)<br>Play the animation, the target object is Avatar
...
| **[on](#on)**(type : string,  caller : any,  listener : Function,  args? : Array<any>): [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject)<br>Use the EventDispatcher object to register an event listener object of the specified type so that the listener can receive event notifications.
| **[once](#once)**(type : string,  caller : any,  listener : Function,  args? : Array<any>): [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject)<br>Use the EventDispatcher object to register an event listener object of the specified type to enable the listener to receive event notifications, which are automatically removed after one response to the listener event.
| **[off](#off)**(type : string,  caller : any,  listener : Function,  onceOnly? : boolean): [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject)<br>Removes the listener from the EventDispatcher object.
| **[offAll](#offAll)**(type? : string): [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject)<br>Removes all listeners of the specified event type from the EventDispatcher object.
## Protected Method
|<div style="width:1000px;text-align:left" >Method</div>   |
| ---  |
...
## constructor
###### **[constructor](#constructor)**(soData? : [SceneObject](?file=006-API-2D单机内核/001-通用/024-SceneObject),  scene? : [ClientScene](?file=006-API-2D单机内核/002-客户端/016-ClientScene)) :
Constructors
##### Parameters
...
## playAnimation
###### **[playAnimation](#playAnimation)**(aniID : number,  loop : boolean,  isHit : boolean,  fps? : number,  superposition? : boolean): [GCAnimation](?file=006-API-2D单机内核/002-客户端/011-GCAnimation) :
...
## on
###### **[on](#on)**(type : string,  caller : any,  listener : Function,  args? : Array<any>): [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject) :
...
## once
###### **[once](#once)**(type : string,  caller : any,  listener : Function,  args? : Array<any>): [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject) :
...
## off
###### **[off](#off)**(type : string,  caller : any,  listener : Function,  onceOnly? : boolean): [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject) :
...
## offAll
###### **[offAll](#offAll)**(type? : string): [ClientSceneObject](?file=006-API-2D单机内核/002-客户端/018-ClientSceneObject) :
