# Tween Jogging class
>Use this type to enable fading of the target object's properties. It is generally used in conjunction with[Ease](?file=007-API-2D网络内核/002-客户端/001-渲染引擎/032-Ease)Use<br><br>
...
| ---  |
| **[to](#to)**(target : any,  props : any,  duration : number,  ease? : Function,  complete? : [Callback](?file=007-API-2D网络内核/001-通用/001-数据结构工具/013-Callback),  delay? : number,  coverBefore? : boolean): [Tween](?file=007-API-2D网络内核/002-客户端/001-渲染引擎/033-Tween)<br>[Static] Jog the props property of the object to the target value.
| **[from](#from)**(target : any,  props : any,  duration : number,  ease? : Function,  complete? : [Callback](?file=007-API-2D网络内核/001-通用/001-数据结构工具/013-Callback),  delay? : number,  coverBefore? : boolean): [Tween](?file=007-API-2D网络内核/002-客户端/001-渲染引擎/033-Tween)<br>[Static] From the props property, jog to the current state.
| **[to](#to)**(target : any,  props : any,  duration : number,  ease? : Function,  complete? : [Callback](?file=007-API-2D网络内核/001-通用/001-数据结构工具/013-Callback),  delay? : number,  coverBefore? : boolean): [Tween](?file=007-API-2D网络内核/002-客户端/001-渲染引擎/033-Tween)<br>Jogs the props property of the object to the target value.
| **[from](#from)**(target : any,  props : any,  duration : number,  ease? : Function,  complete? : [Callback](?file=007-API-2D网络内核/001-通用/001-数据结构工具/013-Callback),  delay? : number,  coverBefore? : boolean): [Tween](?file=007-API-2D网络内核/002-客户端/001-渲染引擎/033-Tween)<br>From the props property, jogs to the current state.
...
| **[clear](#clear)**(tween : [Tween](?file=007-API-2D网络内核/002-客户端/001-渲染引擎/033-Tween)): void<br>[Static] Clean up a certain slow motion.
...
## to
###### **[to](#to)**(target : any,  props : any,  duration : number,  ease? : Function,  complete? : [Callback](?file=007-API-2D网络内核/001-通用/001-数据结构工具/013-Callback),  delay? : number,  coverBefore? : boolean): [Tween](?file=007-API-2D网络内核/002-客户端/001-渲染引擎/033-Tween) :
...
## from
###### **[from](#from)**(target : any,  props : any,  duration : number,  ease? : Function,  complete? : [Callback](?file=007-API-2D网络内核/001-通用/001-数据结构工具/013-Callback),  delay? : number,  coverBefore? : boolean): [Tween](?file=007-API-2D网络内核/002-客户端/001-渲染引擎/033-Tween) :
...
## clear
###### **[clear](#clear)**(tween : [Tween](?file=007-API-2D网络内核/002-客户端/001-渲染引擎/033-Tween)): void :
