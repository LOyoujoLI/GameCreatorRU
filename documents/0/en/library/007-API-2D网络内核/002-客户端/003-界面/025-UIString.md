...
**Subcategories**  [UIInput](?file=007-API-2D网络内核/002-客户端/003-界面/018-UIInput)<br>
## **Public Properties**
...
| **wardWrap** : boolean;<br>Whether or not to automatically line feed Default=true  |
...
##### Parameters
	v Text content $5 means use the player string variable #5
