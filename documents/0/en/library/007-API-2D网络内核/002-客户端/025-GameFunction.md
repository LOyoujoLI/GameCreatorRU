...
| ---  |
| **[shake](#shake)**(strength : number,  duration : number): void<br>[Static] Scene vibration: the current frame vibrates directly, total vibration t frames
...
## shake
###### **[shake](#shake)**(strength : number,  duration : number): void :
