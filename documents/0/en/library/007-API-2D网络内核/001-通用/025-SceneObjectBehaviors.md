...
| **[constructor](#constructor)**(so : SceneObjectEntity,  loop : boolean,  targetSceneObject : [SceneObject](?file=007-API-2D网络内核/001-通用/024-SceneObject),  onOver : Callback,  startIndex? : number,  executor? : SceneObjectEntity)<br>Constructors
...
| **[reset](#reset)**(defSceneObejct : [SceneObject](?file=007-API-2D网络内核/001-通用/024-SceneObject)): void<br>[For Editor Preview]Reset: restore to the most initial state
...
## constructor
###### **[constructor](#constructor)**(so : SceneObjectEntity,  loop : boolean,  targetSceneObject : [SceneObject](?file=007-API-2D网络内核/001-通用/024-SceneObject),  onOver : Callback,  startIndex? : number,  executor? : SceneObjectEntity) :
Constructors
##### Parameters
...
## reset
###### **[reset](#reset)**(defSceneObejct : [SceneObject](?file=007-API-2D网络内核/001-通用/024-SceneObject)): void :
...
-- Global pause, no more next actions to be performed
