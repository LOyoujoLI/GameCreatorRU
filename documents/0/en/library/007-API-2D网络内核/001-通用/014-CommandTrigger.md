...
| **[multiline](#multiline)** : boolean;<br>Multiline mode or not: you can execute the event again without waiting for it to finish  |
...
>// trigger = [CommandTrigger](?file=007-API-2D网络内核/001-通用/014-CommandTrigger) Triggers<br>
...
### multiline
###### multiline : boolean;
Multiline mode or not: you can execute the event again without waiting for it to finish<br>
...
##### Parameters
	...
	targetSceneObject Reference target audience
