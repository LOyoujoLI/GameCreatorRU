...
| ---  |
| **[getAutoTileData](#getAutoTileData)**(texID : number): [AutoTileData](?file=007-API-2D网络内核/001-通用/011-AutoTileData)<br>[Static] Used at runtime to get block data
...
## getAutoTileData
###### **[getAutoTileData](#getAutoTileData)**(texID : number): [AutoTileData](?file=007-API-2D网络内核/001-通用/011-AutoTileData) :
