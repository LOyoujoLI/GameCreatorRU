...
| ---  |
| **[getTileData](#getTileData)**(texID : number): [TileData](?file=007-API-2D网络内核/001-通用/027-TileData)<br>[Static] Get block data
...
## getTileData
###### **[getTileData](#getTileData)**(texID : number): [TileData](?file=007-API-2D网络内核/001-通用/027-TileData) :
